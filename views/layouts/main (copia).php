             ...
             if(!Yii::$app->user->isGuest)
             {
                    ...
                    echo Nav::widget([
                        ...
                        'items' => [
                             ...
                             ['label' => Html::encode(Yii::t('app', 'Kinder')), 'url' => ['/children']],
                             ...
                             ['label' => Html::encode(Yii::t('app', 'Registers')), 'url' => ['/registers']],
                             ['label' => Html::encode(Yii::t('app', 'Registers Extra')), 'url' => ['/registers-extra']],
                             ['label' => Html::encode(Yii::t('app', 'Registers Code Especial')), 'url' => ['/registers-code-especial']],
